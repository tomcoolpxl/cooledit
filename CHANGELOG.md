...
### Changed
- Centralized runtime version information via shared build info so `--version`, the About dialog, and release builds use the same version source
...
[0.5.1]: https://github.com/tomcoolpxl/cooledit/releases/tag/v0.5.1
[0.5.0]: https://github.com/tomcoolpxl/cooledit/releases/tag/v0.5.0
[0.4.0]: https://github.com/tomcoolpxl/cooledit/releases/tag/v0.4.0
[0.3.0]: https://github.com/tomcoolpxl/cooledit/releases/tag/v0.3.0
[0.2.0]: https://github.com/tomcoolpxl/cooledit/releases/tag/v0.2.0
